...
export const downloadSampleCSV = () => {
  const sampleData = [
    { name: 'Nguyễn Văn A', dob: '01/01/1995', time_join: '09/2024', time_leave: '05/2025' },
    { name: 'Trần Thị B', dob: '15/03/1998', time_join: '09/2024', time_leave: '05/2025' },
    { name: 'Lê Văn C', dob: '20/07/1997', time_join: '09/2024', time_leave: '05/2025' }
  ];
